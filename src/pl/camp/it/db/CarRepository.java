...
public class CarRepository {
    ...
    {
        this.vehicleList[0] =
                new Car("audi", "A5", 1999, 300.00, "AWS");
        this.vehicleList[1] =
                new Car("bmw", "3", 1999, 200.00, "QWE");
        this.vehicleList[2] =
                new Bus("solaris", "A1", 4999, 400.00, "ZXC");
        this.vehicleList[3] =
                new Bus("solaris", "A1", 4999, 400.00, "FGH");
        this.vehicleList[4] =
                new Truck("Volvo", "100", 3999, 500.00, "VBN");
    }
        ...
        public boolean rentVehicle(String vin)
        {
            for(Vehicle vehicle : this.vehicleList)
            {
                if(vehicle.getVin().equals(vin))
                {
                    ...
                    return true; //return nic, niczego nie zwracamy,
                }
            }
        return  false;
        }
